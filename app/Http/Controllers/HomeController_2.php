...
public function nilai_rekan_kerja(Request $request) {
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        return view('ketua-tim.rekan-kerja-form', array('lihat_user' => $lihat_user,'LihatUserSpesial' => $LihatUserSpesial));
...
public function nilai_rekan_kerja_proses(Request $request) {
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        $NilaiKaryawanDb = DB::table('nilai-dari-ketua-tim-untuk-ketua-tim')->where('nama_yang_dinilai',$nama_yang_dinilai)
        ->insert(['nama' => $nama, 'nik' => $nik, 'email' => $email, 'no_hp' => $no_hp, 'bagian' => $bagian, 'jabatan' => $jabatan, 'id' => $id, 
        'kompetensi_4_alasan' => $kompetensi_4_alasan,
        'kompetensi_4' => $kompetensi_4,
        ...
        'tanggal_penilaian'     =>  $date,
            ...
            //dd($NilaiDiriSendiriDb);
        return redirect()->action('HomeController_2@nilai_rekan_kerja');
...
public function riwayat_penilaian_rekan_kerja(Request $request) {
    ...
    $cek_role = DB::table('users')->where('id',$id)->first();
    $CekRole = $cek_role -> jabatan;
    $riwayat_nilai_untuk_rekan_kerja = DB::table('nilai-dari-ketua-tim-untuk-ketua-tim')->where('id', $id)->get();
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        if ($riwayat_nilai_untuk_rekan_kerja != null){
            return view('ketua-tim.riwayat-penilaian-rekan-kerja',array('lihat_riwayat' => $riwayat_nilai_untuk_rekan_kerja));
            }
            else{
            return redirect()->action('HomeController_2@nilai_rekan_kerja');    
            }
...
public function report_nilai_dari_rekan_kerja(Request $request) {
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        $id = $request->session()->get('id');
                    ...
                    $cek_nilai_dari_rekan_kerja = DB::table('nilai-dari-ketua-tim-untuk-ketua-tim')->where('nama_yang_dinilai', $get_nama)->get();
                    //dd($cek_nilai_dari_rekan_kerja);
            
                    return view('ketua-tim.lihat-hasil-report-rekan-kerja', array('lihat_user' => $lihat_user, 'lihat_nilai' => $cek_nilai_dari_rekan_kerja, 'tanggal_print' => $date));
    }
...
public function nilai_karyawan(Request $request) {
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        return view('ketua-tim.karyawan-form', array('lihat_user' => $lihat_user,'LihatUserSpesial' => $LihatUserSpesial));
...
public function nilai_karyawan_proses(Request $request) {
    ...
    $LihatUserSpesial = DB::table('users')->where([['jabatan','=', 'karyawan'],])->get();
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        $NilaiKaryawanDbCheck = DB::table('nilai-dari-ketua-tim-untuk-karyawan')->where('nama_yang_dinilai',$nama_yang_dinilai)->get();
        ...
        $NilaiKaryawanDb = DB::table('nilai-dari-ketua-tim-untuk-karyawan')->where('nama_yang_dinilai',$nama_yang_dinilai)
        ->insert(['nama' => $nama, 'nik' => $nik, 'email' => $email, 'no_hp' => $no_hp, 'bagian' => $bagian, 'jabatan' => $jabatan, 'id' => $id, 
        ...
        'tanggal_penilaian'     =>  $date,
            ...
            //dd($NilaiDiriSendiriDb);
        return redirect()->action('HomeController_2@nilai_karyawan');
...
public function riwayat_penilaian_karyawan(Request $request) {
    ...
    $cek_role = DB::table('users')->where('id',$id)->first();
    $CekRole = $cek_role -> jabatan;
    $riwayat_nilai_untuk_rekan_kerja = DB::table('nilai-dari-ketua-tim-untuk-karyawan')->where('id', $id)->get();
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        if ($riwayat_nilai_untuk_rekan_kerja != null){
            return view('ketua-tim.riwayat-penilaian-karyawan',array('lihat_riwayat' => $riwayat_nilai_untuk_rekan_kerja));
            }
            else{
            return redirect()->action('HomeController_2@nilai_karyawan');    
            }
...
public function report_nilai_dari_karyawan(Request $request) {
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        $id = $request->session()->get('id');
                    ...
                    $cek_nilai_dari_rekan_kerja = DB::table('nilai-dari-karyawan-untuk-ketua-tim')->where('nama_yang_dinilai', $get_nama)->get();
                    //dd($cek_nilai_dari_rekan_kerja);
            
                    return view('ketua-tim.lihat-hasil-report-karyawan', array('lihat_user' => $lihat_user, 'lihat_nilai' => $cek_nilai_dari_rekan_kerja, 'tanggal_print' => $date));
    }
...
public function nilai_pimpinan(Request $request) {
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        return view('ketua-tim.pimpinan-form', array('lihat_user' => $lihat_user,'LihatUserSpesial' => $LihatUserSpesial));
...
public function nilai_pimpinan_proses(Request $request) {
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        $NilaiKaryawanDb = DB::table('nilai-dari-ketua-tim-untuk-direksi')->where('nama_yang_dinilai',$nama_yang_dinilai)
        ->insert(['nama' => $nama, 'nik' => $nik, 'email' => $email, 'no_hp' => $no_hp, 'bagian' => $bagian, 'jabatan' => $jabatan, 'id' => $id, 
        'kompetensi_4_alasan' => $kompetensi_4_alasan,
        'kompetensi_4' => $kompetensi_4,
        ...
        'tanggal_penilaian'     =>  $date,
            ...
            //dd($NilaiDiriSendiriDb);
        return redirect()->action('HomeController_2@nilai_pimpinan');
...
public function riwayat_penilaian_pimpinan(Request $request) {
    $id = $request->session()->get('id');
    $cek_role = DB::table('users')->where('id',$id)->first();
    $CekRole = $cek_role -> jabatan;
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        if ($riwayat_nilai_untuk_rekan_kerja != null){
            return view('ketua-tim.riwayat-penilaian-pimpinan',array('lihat_riwayat' => $riwayat_nilai_untuk_rekan_kerja));
            }
            else{
            return redirect()->action('HomeController_2@nilai_pimpinan');    
            }
...
public function report_nilai_dari_pimpinan(Request $request) {
    ...
    if($request->session()->get('login') && $CekRole == 'Ketua Tim' || $request->session()->get('login') && $CekRole == 'ketua tim' ) {
        ...
        $id = $request->session()->get('id');
                    ...
                    $cek_nilai_dari_rekan_kerja = DB::table('nilai-dari-direksi-untuk-ketua-tim')->where('nama_yang_dinilai', $get_nama)->get();
                    //dd($cek_nilai_dari_rekan_kerja);
            
                    return view('ketua-tim.lihat-hasil-report-pimpinan', array('lihat_user' => $lihat_user, 'lihat_nilai' => $cek_nilai_dari_rekan_kerja, 'tanggal_print' => $date));
    }
