...
<li class="nav-small-cap m-t-10">--- Pilihan Menu</li>
                    ...
                    <li> <a href="javascript:void(0)" class="waves-effect"><i class="fa fa-star p-r-10"></i> <span class="hide-menu waves-effect active">Penilaian<span class="fa arrow"></span></span></a>
                         <ul class="nav nav-second-level">
                            ...
                            <li class="waves-effect active"> <a href="{{env('APP_URL')}}/pimpinan/nilai-rekan-kerja">Penilaian untuk Rekan Kerja</a> </li>
                        ...
                        <div class="panel panel-success">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="{{url('/pimpinan/nilai-rekan-kerja-proses')}}" method="post" class="form-horizontal form-bordered">
                                    {{csrf_field()}}
                                        <div class="form-body">
...
<a href="{{env('APP_URL')}}/pimpinan/riwayat-penilaian-rekan-kerja"><button class="sm-12 btn btn-warning">Riwayat penilaian rekan kerja </button></a>
</div>
