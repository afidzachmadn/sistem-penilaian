...
<li class="nav-small-cap m-t-10">--- Pilihan Menu</li>
                    ...
                    <li> <a href="javascript:void(0)" class="waves-effect"><i class="fa fa-star p-r-10"></i> <span class="hide-menu waves-effect active">Penilaian<span class="fa arrow"></span></span></a>
                         <ul class="nav nav-second-level">
                            ...
                            <li class="waves-effect active"> <a href="{{env('APP_URL')}}/pimpinan/nilai-karyawan">Penilaian untuk Karyawan</a> </li>
                    ...
                    <li> <a href="javascript:void(0)" class="waves-effect"><i class="fa  fa-bolt p-r-10"></i> <span class="hide-menu waves-effect ">Lihat Hasil Penilaian<span class="fa arrow"></span></span></a>
                         <ul class="nav nav-second-level">
                            ...
                            <li class="waves-effect"> <a href="{{env('APP_URL')}}/pimpinan/report-nilai-dari-ketua-tim">Dari Tim</a> </li>
                        </ul>
                    </li>
                        ...
                        <div class="panel panel-success">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="{{url('/pimpinan/nilai-karyawan-proses')}}" method="post" class="form-horizontal form-bordered">
                                    {{csrf_field()}}
                                        <div class="form-body">
...
<a href="{{env('APP_URL')}}/pimpinan/riwayat-penilaian-karyawan"><button class="sm-12 btn btn-warning">Riwayat penilaian karyawan </button></a>
</div>
