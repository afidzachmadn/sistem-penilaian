                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body">
                                    <form action="{{url('nilai-pimpinan-proses')}}" method="post" class="form-horizontal form-bordered">
                                    {{csrf_field()}}
                                        <div class="form-body">
...
<a href="/riwayat-penilaian-untuk-pimpinan"><button class="sm-12 btn btn-warning">Riwayat penilaian untuk pimpinan </button></a>
</div>
