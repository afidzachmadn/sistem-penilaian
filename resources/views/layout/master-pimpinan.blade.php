    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <div class="top-left-part"><a class="logo" href="{{env('APP_URL')}}/pimpinan/dashboard"><b><img src="{{env('APP_URL')}}/plugins/images/header-gambar.png" alt="home" /></b>&nbsp<span class="hidden-xs"><strong>DBA</strong>systems</span></a></div>
                <!-- /Logo -->
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="user-pro">
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="{{env('APP_URL')}}/pimpinan/data-diri"><i class="fa fa-user"></i>Data Diri</a></li>
                            <li><a href="{{env('APP_URL')}}/logout"><i class="fa fa-power-off"></i> Logout</a></li>
                        </ul>
                    </li>
                    <!-- yield sidebar -->

                    @yield('sidebar-dashboard-pimpinan')
                    <!--
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <!-- letakan yield -->
                @yield('breadcrumb-dashboard-pimpinan')
                <!--
                ...
                <!-- contents start here -->
                    @yield('header-dashboard-pimpinan')
