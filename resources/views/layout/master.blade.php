    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <div class="top-left-part"><a class="logo" href="/dashboard"><b><img src="{{env('APP_URL')}}/plugins/images/header-gambar.png" alt="home" /></b>&nbsp<span class="hidden-xs"><strong>DBA</strong>systems</span></a></div>
                <!-- /Logo -->
